\chapter{Critical Zone}

\chapterauthor{Marc Los Huertos}

\acknowledgement{The chapter was first drafted by Marc Los Huertos (2021). The author recieved valuable feedback from X, and Y and Z to improve the chapter. Slater revised the chapter in 2022 with suggestions from Cater.}
...
\section{The Vadose Zone}

Jeji is a volcanic island is located some XX km south of the Korean Penisula. Water runs off the steep slopes quickly and water supplies are limited on the island. To adddress this...[@lee2017fifty].

%```{r vadose, echo=FALSE, fig.align = 'center', out.width = "100%", fig.cap = "... (Source: [@lee2017fifty])."}
%knitr::include_graphics(here::here("images/Chap02", "Lee_Vadose.png"))
%```
