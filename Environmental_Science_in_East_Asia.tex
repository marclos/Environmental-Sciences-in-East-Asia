...
\begin{figure}
\includegraphics[width=\textwidth]{images/TDGTME.png}
\caption{TME data for a big dam and down how the area flooded correlates in the planning stages? EXPLAIN ME MORE}
\label{fig:tgdmap}
\end{figure}
