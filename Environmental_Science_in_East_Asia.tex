...
\begin{figure}
includegraphics{images/earth-system/earth-rad-budget-nasa-erbe.gif}
\caption{caption}
...
As the sun's electromagnetic radiation interacts with the Earth's Atmosphere, certain wavelengths are absorbed and filtered out \ref{fig:em-entering}.

begin{figure}
\includegraphics[]{images/earth-system/em-radiation-atmosph-depth-stsci.jpg}
...
\begin{figure}
\includegraphics{images/earth-system/Carbon-reservoirs-and-cycles-in-the-Earth.jpg}
...
\begin{figure}
\includegraphics{images/earth-system/long-term-carbon.gif}
...
\begin{figure}
\includegraphics{images/earth-system/Q10_SOC_Regulation.jpg}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=\maxwidth]{figure/maunaloa2-1} 
